...
const ImageEditor = ({onClose,previewURL,settings,setSettings}:{
    ...
    return (
        <div className="fixed w-screen h-screen left-0 top-0 bg-black bg-opacity75 z-10 flex items-center justify-center">
            <div className="bg-black rounded-xl p-12 flex flex-col gap-4">
                {/** TOP */}
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-8">
                        <Image src="icons/back.svg" alt="" onClick={onClose} className="cursor-pointer" height={20} width={20}/>
                    </div>
                    <h1 className="font-bold text-xl">Image Settings</h1>
